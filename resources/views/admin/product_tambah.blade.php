...
<head>
    ...
    <title>Tambah Produk - Halalytics</title>
    ...
    <div class="page-container">
        <div class="card">
            <div class="card-header">
                <h5><i class="fas fa-plus-circle"></i> Tambah Produk Baru</h5>
            </div>
        <div class="card-body">
                @if ($errors->any())
            ...
            <form action="{{ route('admin_product.store') }}" method="POST">
                ...
                <div class="mb-3">
                            ...
                            <textarea name="komposisi" 
                                      ...
                                      rows="4"
                                      placeholder="Masukkan komposisi produk">{{ old('komposisi') }}</textarea>
                            @error('komposisi')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                </div>
                ...
                <div class="mb-3">
                            ...
                            <textarea name="info_gizi" 
                                      ...
                                      rows="4"
                                      placeholder="Masukkan informasi gizi produk">{{ old('info_gizi') }}</textarea>
                            @error('info_gizi')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="mb-3">
                            ...
                            <select name="status" 
                                ...
                                <option value="halal" {{ old('status') == 'halal' ? 'selected' : '' }}>Halal</option>
                                <option value="haram" {{ old('status') == 'haram' ? 'selected' : '' }}>Haram</option>
                                <option value="syubhat" {{ old('status') == 'syubhat' ? 'selected' : '' }}>Syubhat</option>
                    </select>
                            @error('status')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
