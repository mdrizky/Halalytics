...
<div class="flex items-center justify-between mb-8">
    <div>
        <h2 class="text-2xl font-extrabold text-slate-800 dark:text-white tracking-tight">Participant Verification</h2>
        <p class="text-slate-500 text-sm mt-1">Verify donor attendance and record blood stocks.</p>
    </div>
