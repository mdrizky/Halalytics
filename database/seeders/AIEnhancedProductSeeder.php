    ...
    public function run()
    {
        ...
        $products = [
            [
                ...
                'active' => true,
                'source' => 'local',
                'kategori_id' => KategoriModel::where('nama_kategori', 'Makanan Kaleng & Kemasan')->value('id_kategori'),
            ...
            [
                ...
                'active' => true,
                'source' => 'local',
                'kategori_id' => KategoriModel::where('nama_kategori', 'Minuman Ringan')->value('id_kategori'),
